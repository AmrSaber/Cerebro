...
\begin{titlepage}
	\begin{figure}[hp]
		\includegraphics[width=0.22\textwidth]{images/benha.jpeg}
		\hspace{0.31\textheight}
		\includegraphics[scale=0.25]{images/feng.jpeg}
	\end{figure}
	...
	\begin{tabular}[width=0.9\textwidth]{m{8cm}  m{8cm}}
		Amr Mohamed Saber & Manar Arabi Kamel \\
		Mohamed Ahmed Abd-elmagid Kheder & Muhammad Aref Muhammad Abdo\\
		Salma Sayed Hussein Muhammad & Wafaa Ismail Ibrahim
		%  El-Debies
	\end{tabular}
	}
